...
class EmployeesController extends Controller
{
    ...
    public function search(string $name){
        $employee = Employees::where('name', 'like', "%{$name}%")->get();
    ...
    public function active(){
        ...
        $total = Employees::where('status', 'active')->count();
    ...
    public function inactive(){
        ...
        $total = Employees::where('status', 'inactive')->count();
    ...
    public function terminated(){
        ...
        $total = Employees::where('status', 'terminated')->count();
